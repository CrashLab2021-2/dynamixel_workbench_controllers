...
class DynamixelController
{
 private:
  ...
  ros::Subscriber door1;
  ros::Subscriber door2;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  // ROS Service Server
  ros::ServiceServer dynamixel_command_server_;
  ros::ServiceServer door;
  ros::ServiceServer tilt;
  ros::ServiceServer dispenser;
 ...
 public:
  ...
  bool doorCallback(kanu_msgs::door::Request &req, kanu_msgs::door::Response &res);
  bool tiltCallback(kanu_msgs::tilt::Request &req, kanu_msgs::tilt::Response &res);
  bool dispenserCallback(kanu_msgs::dispenser::Request &req, kanu_msgs::dispenser::Response &res);

  void doorOpen(const std_msgs::Int16::ConstPtr &msg);
  void singleOpen(const std_msgs::Int16::ConstPtr &msg);
};
